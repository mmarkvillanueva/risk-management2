...
module.exports = cds.service.impl(async function () {
    ...
    // Connecto to Remote Service
    const BPsrv = await cds.connect.to("API_BUSINESS_PARTNER");

    /**
     * Event-handler for read-events on the BusinessPartners entity.
     * Each request to the API Business Hub requires apikey in the header.
     */
    ...
    this.on("READ", Risks, async (req, next) => {
         ...
         * As this is not possible, the risk entity and the business partner entity are in different systems (SAP BTP and S/4HANA Cloud),
         * If there is such an expand, remote it
         */
        ...
        /**
         * Intesad of carrying out the expand, issue a seperate request for each business partner
         * This code could be optimized, instead of having n requets for n business partnerse
         */
        try {
